...
! Initialize
!-----------------------------------------------------------------------
SUBROUTINE set_common_obs_afes
  IMPLICIT NONE
...
!  REAL(r_size),ALLOCATABLE :: tmp2k(:)
  ...
  WRITE(6,'(A)') 'Hello from set_common_obs_afes'
...
!  DEALLOCATE( tmp2k )
  ...
  RETURN
END SUBROUTINE set_common_obs_afes
!-----------------------------------------------------------------------
