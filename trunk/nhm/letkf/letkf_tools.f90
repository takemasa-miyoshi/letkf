...
SUBROUTINE das_letkf(gues3d,gues2d,anal3d,anal2d)
  ...
  REAL(r_size) :: parm_infl ! spread inflation parameter
  REAL(r_size) :: parm
...
!$OMP PARALLEL DO PRIVATE(ilev,ij)
  DO m=1,nbv
    DO ilev=1,nlev
      DO ij=1,nij1
        anal3d(ij,ilev,m,iv3d_qv) = MAX(anal3d(ij,ilev,m,iv3d_qv),0.0d0)
        anal3d(ij,ilev,m,iv3d_qc) = MAX(anal3d(ij,ilev,m,iv3d_qc),0.0d0)
        anal3d(ij,ilev,m,iv3d_qr) = MAX(anal3d(ij,ilev,m,iv3d_qr),0.0d0)
        anal3d(ij,ilev,m,iv3d_qi) = MAX(anal3d(ij,ilev,m,iv3d_qi),0.0d0)
        anal3d(ij,ilev,m,iv3d_qs) = MAX(anal3d(ij,ilev,m,iv3d_qs),0.0d0)
        anal3d(ij,ilev,m,iv3d_qh) = MAX(anal3d(ij,ilev,m,iv3d_qh),0.0d0)
      END DO
    END DO
  END DO
!$OMP END PARALLEL DO
