...
!
  ...
  WRITE(6,'(A)') '          Based on Hunt et al (2007)         '
  WRITE(6,'(A)') '      Tested by Miyoshi and Yamane (2007)    '
  WRITE(6,'(A)') '============================================='
  ...
  WRITE(6,'(A)') '============================================='
  CALL set_common_afes
  CALL set_common_mpi_afes
