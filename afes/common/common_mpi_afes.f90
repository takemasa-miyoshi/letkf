...
CONTAINS
SUBROUTINE set_common_mpi_afes
  ...
  WRITE(6,'(A)') 'Hello from set_common_mpi_afes'
  ...
  RETURN
END SUBROUTINE set_common_mpi_afes
!-----------------------------------------------------------------------
